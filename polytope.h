...
class polytope {
  ...
  const float walk(float* norm, float* x, float* Ax, const float* B, const float* A_negrecp, const __m256* Agt,  const __m256* Alt, const float rk, XoshiroCpp::Xoshiro128PlusPlus &rng) const;
